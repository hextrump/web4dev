const layoutContent = {
    ...
    js: [
        ...
        '            { id: \'points-container\', type: \'points\' }',
        '        ];',
        '',
        ...
        '    try {',
        '        const query = \'query GetWidget { transactions(tags: [{ name: "Content-Type", values: ["application/json"] }, { name: "scinet", values: ["\' + widgetType + \'"] }, { name: "Version", values: ["0.1.7"] }], owners: ["A5Hzm1b3mtQfYfU6q5qvKeVJmoaReCvthwfHuZkBBdAQ"], limit: 1, order: DESC) { edges { node { id address tags { name value } } } } }\';',
        '',
